...
#                                                           'LIMIT 1;')
SUBMISSION_SELECT_TOP_SUBMISSION_FOR_CHALLENGE_BY_USER = 'SELECT id, result_score as maxscore FROM challenges_submission WHERE challenge_id = %s and author_id = %s and pending = 0 ORDER by result_score DESC LIMIT 1;'
