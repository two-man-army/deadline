...
NOTIFICATION_TYPE_CONTENT_FIELDS = {
    ...
    RECEIVE_NW_ITEM_LIKE_NOTIFICATION: ['liker_id', 'liker_name', 'nw_item_type', 'nw_item_content', 'nw_item_id'],
    RECEIVE_NW_ITEM_LIKE_NOTIFICATION_SQUASHED: ['likers', 'nw_item_type', 'nw_item_content', 'nw_item_id'],
