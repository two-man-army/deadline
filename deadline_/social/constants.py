...
RECEIVE_SUBMISSION_LIKE_NOTIFICATION = 'RECEIVE_SUBMISSION_LIKE'

VALID_NOTIFICATION_TYPES = [RECEIVE_FOLLOW_NOTIFICATION, RECEIVE_SUBMISSION_LIKE_NOTIFICATION]
...
NOTIFICATION_TYPE_CONTENT_FIELDS = {
    ...
    RECEIVE_SUBMISSION_LIKE_NOTIFICATION: ['submission_id', 'challenge_id', 'challenge_name', 'liker_id', 'liker_name']
}
